...
describe('SignUp Controller', () => {
  ...
  test('Shuold return 400 if an invalid email provided', () => {
  ...
  test('Shuold return 400 if password confirmation fails', () => {
    const { sut, emailValidatorStub } = makeSut()
    jest.spyOn(emailValidatorStub, 'isValid').mockReturnValueOnce(false)
  ...
  test('Shuold call EmailValidator with correct email', () => {
    const { sut, emailValidatorStub } = makeSut()
  ...
  test('Shuold return 500 if email validator throws', () => {
    const { sut, emailValidatorStub } = makeSut()
  ...
  test('Shuold call AddAccount with correct values', () => {
